...
<body>
    <div class="container">
        <div class="col-md-12">
            ...
            <form method="post" action="edit_aksi.php" class="form_hotizontal">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input type="radio" name="jenis_kelamin" class="form-check-label" value="Laki-Laki" <?php if($mhs['jenis_kelamin'] == 'Laki-Laki') echo 'checked' ?>>
                        <label class="form-check-label">
                            Pria
                        </label>
                    </div>
                    <div class="form-check">
                        <input type="radio" name="jenis_kelamin" class="form-check-label" value="Perempuan" <?php if($mhs['jenis_kelamin'] == 'Perempuan') echo 'checked' ?>>
                        <label class="form-check-label">
                            Wanita
                        </label>
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="program_studi" class="form-select">
                        ...
                        <option value="Pariwisata" <?php if($mhs['program_studi'] == 'Pariwisata') echo 'selected' ?>>Pariwisata</option>
                    </select>
                </div>
